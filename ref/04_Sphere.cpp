...
void Draw(void)
{
	...
	//处理图形的旋转
	vmath::mat4 trans = vmath::perspective(60, aspact,1.0f,500.0f) *vmath::translate(0.0f, 0.0f, -5.0f)* vmath::rotate(xRot, vmath::vec3(1.0, 0.0, 0.0)) * vmath::rotate(yRot, vmath::vec3(0.0, 1.0, 0.0));
