...
void Draw(void)
{
	...
	//处理图形的旋转
	switch (rotMode) {
	case 1: xRot -= 5.0f; yRot = 20.0f; break;
	case 2: xRot += 5.0f; yRot = 20.0f; break;
	case 3: yRot -= 5.0f; xRot = 20.0f; break;
	case 4: yRot += 5.0f;xRot = 20.0f; break;
	}
...
int main()
{
	...
	//显示操作说明
	std::cout << "方向键可以控制图形的旋转方向。" << std::endl;
